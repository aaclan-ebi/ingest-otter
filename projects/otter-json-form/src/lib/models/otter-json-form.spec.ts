...
describe('MetadataForm', () => {
  ...
  it('return FormGroup obj', () => {
    ...
    // when
    const metadataForm = new OtterJsonForm('project', testSchema);
  ...
  it('return FormGroup obj with data', () => {
    ...
    // when
    const metadataForm = new OtterJsonForm('project', testSchema, testData);
    const formGroup = metadataForm.formGroup;
  ...
  it('return metadataRegistry', () => {
    ...
    // when
    const metadataForm = new OtterJsonForm('project', testSchema, testData);
    const metadataRegistry = metadataForm.propertyRegistry;
  ...
  it('return metadataRegistry with config', () => {
    ...
    // when
    const metadataForm = new OtterJsonForm('project', testSchema, testData, config);
    const metadataRegistry = metadataForm.propertyRegistry;
  ...
  describe('getControl', () => {
    let metadataForm: OtterJsonForm;
    let testData: object;

    beforeEach(() => {
      testData = (json as any).default;
      metadataForm = new OtterJsonForm('project', testSchema, testData);
    });
