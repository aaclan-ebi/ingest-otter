  ...
  describe('JsonProperty types', () => {
    describe('isScalar', () => {
      it('return True', () => {
        ...
        // when
        const field = new JsonProperty({isRequired: false, key: 'describedBy', schema: scalar});
    ...
    describe('isScalarList', () => {
      it('return True', () => {
        ...
        // when
        const field = new JsonProperty({isRequired: false, key: 'array_express_accessions', schema: scalarList});
    ...
    describe('isObject', () => {
      it('return True', () => {
        ...
        // when
        const field = new JsonProperty({isRequired: true, key: 'array_express_accessions', schema: obj});
    ...
    describe('isObjectList', () => {
      it('return True', () => {
        ...
        const field = new JsonProperty({isRequired: true, key: 'array_express_accessions', schema: objectList});
